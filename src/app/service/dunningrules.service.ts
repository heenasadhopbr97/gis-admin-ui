...
export class DunningrulesService {
  ...
  getDunningRuleList(data:any){
    return this.http.post(`${this.baseUrl}/dunningrule/list`, data);
  }

  searchDunningRule(data:any){
    return this.http.post(`${this.baseUrl}/dunningrule/search`, data);
  }
