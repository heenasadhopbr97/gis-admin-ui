...
import { KEYANNA_PRODUCT_MANAGEMENT_BASE_URL } from "src/app/RadiusUtils/RadiusConstants";

@Injectable({
  providedIn: "root",
})
export class subBusinessVerticalService {
  baseUrl = RadiusConstants.KEYANNA_API_GATEWAY_COMMON_MANAGEMENT + "/subbusinessvertical";
