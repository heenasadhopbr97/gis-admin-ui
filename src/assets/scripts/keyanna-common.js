$(document).ready(function () {
  ...
  $("smp a").on("click", function () {
    $(this).addClass("active");
  });
  $("controller a").on("click", function () {
    $(this).addClass("active");
  });
...
//Called when click on table row.
// $("#myTable tbody").on("click", "tr",
// 	function () {
// 		//console.log($(this).text());
// 		$(this).addClass('selected-row-background').siblings().removeClass('selected-row-background');
// 	});
