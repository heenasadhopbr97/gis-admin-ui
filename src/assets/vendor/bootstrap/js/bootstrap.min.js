...
+(function (a) {
  ...
  +(function (a) {
    ...
    var e = function (c) {
      var d,
        e = a(this),
        f = a(e.attr("data-bs-target") || ((d = e.attr("href")) && d.replace(/.*(?=#[^\s]+$)/, "")));
  ...
  +(function (a) {
    ...
    function b(b) {
      var c,
        d = b.attr("data-bs-target") || ((c = b.attr("href")) && c.replace(/.*(?=#[^\s]+$)/, ""));
      return a(d);
    }
    function c(b) {
      return this.each(function () {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (!(e && e.length && ((b = e.data("bs.collapse")), b && b.transitioning))) {
            ...
            if ((this.$element.trigger(f), !f.isDefaultPrevented())) {
              ...
              var h = function () {
                this.$element.removeClass("collapsing").addClass("collapse show")[g](""),
    ...
    (a.fn.collapse = c),
      ...
      a(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function (d) {
        var e = a(this);
        e.attr("data-bs-target") || d.preventDefault();
        var f = b(e),
  ...
  +(function (a) {
    ...
    (a.fn.modal = b),
      ...
      a(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function (c) {
        var d = a(this),
          e = d.attr("href"),
          f = a(d.attr("data-bs-target") || (e && e.replace(/.*(?=#[^\s]+$)/, ""))),
          g = f.data("bs.modal")
            ? "toggle"
  ...
  +(function (a) {
    ...
    (b.VERSION = "3.3.7"),
      ...
      (b.prototype.activate = function (b) {
        ...
        var c = this.selector + '[data-bs-target="' + b + '"],' + this.selector + '[href="' + b + '"]',
