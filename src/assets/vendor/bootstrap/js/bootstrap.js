...
+(function ($) {
  ...
  var Collapse = function (element, options) {
    ...
    this.$trigger = $(
      '[data-toggle="collapse"][href="#' +
        element.id +
        '"],' +
        '[data-toggle="collapse"][data-bs-target="#' +
        element.id +
        '"]'
    );
  ...
  Collapse.prototype.show = function () {
    ...
    var complete = function () {
      this.$element.removeClass("collapsing").addClass("collapse show")[dimension]("");
  ...
  Collapse.prototype.hide = function () {
    ...
    this.$element.addClass("collapsing").removeClass("collapse show").attr("aria-expanded", false);
...
+(function ($) {
  ...
  ScrollSpy.prototype.activate = function (target) {
    ...
    var selector =
      this.selector + '[data-bs-target="' + target + '"],' + this.selector + '[href="' + target + '"]';
